...
namespace Day03
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ColorWriteLine("Hello, World!");
            ColorWriteLine("Hello again!", ConsoleColor.Red);
        ...
        static void BatTheme(int naCount = 13)
        {
        ...
        static void ColorWriteLine(string message, ConsoleColor color = ConsoleColor.White) 
        {
