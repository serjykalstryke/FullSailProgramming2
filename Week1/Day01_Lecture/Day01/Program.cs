    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            /*
                CHALLENGE 1:
                    ...
                    Call the method on the t800 calculator instance and print the results.

            */
            Calculator t800 = new Calculator();
            bool isNumberEven = t800.IsEven(number);
            Console.WriteLine($"Is {number} even? {isNumberEven}");
            ...
            */
            ...
            List<float> grades = new List<float> { 90.5f, 87.5f, 78.9f, 95.2f };
            ...
            */
            ...
            /*
                BOSS CHALLENGE:
                    ...
                    2) Call the Average method on the t800 variable and pass your grades list to the method.
                    3) print the average that is returned.
             
            */
            float averageGrade = t800.Average(grades);
